...
namespace EK.Datos.SCV.Sybase17
{
          ...
          : d.Kontrol.DAOBaseGeneric<m.SCV.Interfaces.IConsultaViviendaEntregable>, d.SCV.Interfaces.IConsultaViviendaEntregables
    {
        ...
        private const string USP_SPV_CONSULTA_CONSULTAPERSONAENTREGAV_SELECT = "usp_spv_personal_entrega_viv_select";
        ...
        private const string UPS_SPV_REPORTE_ENCUESTA_ENTREGA_VIVIENDA = "USP_SPV_REPORTEENCUESTAENTREGAVIVIENDA";
        ...
        public async Task<object[]> GetReporteEncuestaEntregaVivienda(Dictionary<string, object> parametros)
        {
            try
            {
                ...
                return await helper.CreateEntitiesAsync(
                    UPS_SPV_REPORTE_ENCUESTA_ENTREGA_VIVIENDA, CommandType.StoredProcedure, parametros);
            }
            catch (Exception ex)
            {
                throw ex;
