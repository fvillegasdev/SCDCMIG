...
{
    public class Tickets : p.Kontrol.BPBase<m.SCV.Interfaces.ITicket, d.SCV.Interfaces.ITickets>, p.SCV.Interfaces.ITickets
    {
        private const string USP_SPV_Tickets_SELECT = "usp_spv_tickets_select";

        public Tickets(m.Kontrol.Interfaces.IContainerFactory factory, d.SCV.Interfaces.ITickets dao)
            : base(factory, dao, "Tickets")
        { }
