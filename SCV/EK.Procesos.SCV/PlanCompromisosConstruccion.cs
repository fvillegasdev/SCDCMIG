...
{
    public class PlanCompromisosConstruccion : p.Kontrol.BPBase<m.SCV.Interfaces.IPlanCompromisosConstruccion, d.SCV.Interfaces.IPlanCompromisosConstruccion>, p.SCV.Interfaces.IPlanCompromisosConstruccion
    {
       

        public PlanCompromisosConstruccion(m.Kontrol.Interfaces.IContainerFactory factory, d.SCV.Interfaces.IPlanCompromisosConstruccion dao)
            : base(factory, dao, "PlanCompromisosConstruccion")
        { }
