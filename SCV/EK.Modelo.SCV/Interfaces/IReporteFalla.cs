...
namespace EK.Modelo.SCV.Interfaces
{
    ...
    public interface IReporteFalla : m.Kontrol.Interfaces.IBaseKontrol
    {
        ...
        [m.Kontrol.Column("smza")]
        string SuperManzana { get; set; }

        [m.Kontrol.Column("mza")]
        string Manzana { get; set; }

        [m.Kontrol.Column("lote")]
        string Lote { get; set; }

        [m.Kontrol.Column("interior")]
        string Interior { get; set; }

        [m.Kontrol.Column("exterior")]
        ...
        string IndicadorCliente { get; set; }
        ...
        [m.Kontrol.Column("fecha_standby")]
        DateTime? FechaStandByCancelar { get; set; }

        [m.Kontrol.Column("standby_cancelar")]
        ...
        List<m.SCV.Interfaces.IReporteFallaDetalle> DictamenesPartidas { get; set; }
        ...
        string MensajeAppGarantias { get; set; }
        string redirectReporteUrl { get; set; }
        List<m.SCV.Interfaces.IEvidenciaDiagnostico> EvidenciasReporte { get; set; }
        List<m.SCV.Interfaces.IAgendaContratista> HistorialFechasOT { get; set; }

        string listaFamilias { get; set; }
    }
}