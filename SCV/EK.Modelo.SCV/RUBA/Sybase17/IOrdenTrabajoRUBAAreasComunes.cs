...
{
    [m.Kontrol.Table("spv_ordenes_trabajo_areas_comunes")]
    public interface IOrdenTrabajoRUBAAreasComunes
        : m.Kontrol.Interfaces.IBaseKontrol
    {
        ...
        List<m.SCV.Interfaces.IOrdenTrabajoDetalleRUBAAreasComunes> Partidas { get; set; }
