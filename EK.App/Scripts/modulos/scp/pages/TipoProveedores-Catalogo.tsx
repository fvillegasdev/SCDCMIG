namespace EK.Modules.SCP.Pages.TipoProveedores {
    "use strict";
    const config: page.IPageConfig = global.createPageConfig("TipoProveedores", "kontrol");
    let ml: any = config.getML();
    let subTitulo: string = "Tipo de Proveedor"
