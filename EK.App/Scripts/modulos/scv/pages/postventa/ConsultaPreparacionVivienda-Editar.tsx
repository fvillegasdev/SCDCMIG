namespace EK.Modules.SCV.Pages.postventa.ConsultaPreparacionVivienda {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("ConsultaPreparacionVivienda", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Consulta Preparacion Vivienda";
                ...
                <Column size={[12, 12, 12, 12]} style={{ paddingTop: 8 }}>
                    <page.OptionSection
                        ...
                        <Row>
                            ...
                            <input.Descripcion size={[12, 12, 8, 8]} validations={[validations.required()]} />
                ...
                <Column size={[12, 12, 12, 12]}>
                    <page.OptionSection
                        ...
                        <Row>
                            ...
                            <label.Descripcion size={[12, 12, 8, 8]} />
