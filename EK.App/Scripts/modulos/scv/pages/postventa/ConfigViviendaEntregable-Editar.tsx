namespace EK.Modules.SCV.Pages.postventa.ConfigViviendaEntregable {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("ConfigViviendaEntregable", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Configuracion Vivienda Entregable";
