namespace EK.Modules.SCV.Pages.postventa.ConsultaViviendaEntregable {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("ConsultaViviendaEntregable", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Consulta Vivienda Entregable";
