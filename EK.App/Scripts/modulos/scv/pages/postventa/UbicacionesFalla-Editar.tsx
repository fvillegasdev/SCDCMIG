                ...
                <Column size={[12, 12, 12, 12]} style={{ paddingTop: 8 }}>
                    <page.OptionSection
                        ...
                        <Row>
                            ...
                            <input.Nombre size={[12, 12, 4, 4]} validations={[validations.required()]} />
                            <UsoFallaDDL id="UsoFalla" size={[12,12,4,4]}/>
                ...
                <Column size={[12, 12, 12, 12]}>
                    <page.OptionSection
                        ...
                        <Row>
                            ...
                            <label.Entidad id="UsoFalla" size={[12, 12, 4, 4]} />
