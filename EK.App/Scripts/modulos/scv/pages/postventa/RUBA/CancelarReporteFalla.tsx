namespace EK.Modules.SCV.Pages.postventa.RUBA.CancelarFolio {
    "use strict";
    ...
    let ModalComentarios: any = global.connect(class extends React.Component<IModalComentariosProps, {}> {
        ...
        onCancelarFolio() {
            ...
            let fnClose = (motivoObj) => {
                ...
                global.dispatchAsyncPut("global-current-entity", "base/scv/ReportesFallas/GetBP/CancelaReporte", {motivo} );
            };
...
import ModalCancelarFolio = EK.Modules.SCV.Pages.postventa.RUBA.CancelarFolio.CancelarFolioModalBase;