namespace EK.Modules.SCV.Pages.Reportes.ConsultaIncidenciasEntregaVivienda {
    "use strict";
    const PAGE_ID: string = "ReporteIncidenciasEntregaVivienda";
    const PAGE_RESULTADOS_ID: string = "ReporteIncidenciasEntregaVivienda$resultados";
        ...
        onFilter(props: page.IProps, filtros: any, type?: string): void {
            if (getData(props.page).id === config.id) {
                ...
                const columnas = [
                    ...
                    //},
                    { caption: "Generado en Folio", dataField: "generoFolio" },
                    { caption: "# Cliente", dataField: "numcliente", alignment: 'center' },
                    { caption: "Cliente", dataField: "cliente", alignment: 'center' },
                    { caption: "Vivienda entregada", dataField: "Entregado", alignment: 'center' },
                    ...
                    { caption: "Fecha Captura", dataField: "fechaReporte", alignment: 'center', dataType: "datetime", format: "dd/MM/yyyy HH:mm" },
                ...
                console.log(filters)
                global.asyncPost("base/scv/reportesFallasConsulta/GetBP/GetConsultaIncidenciasEntrega/", {parametros:filters} , (status: AsyncActionTypeEnum, data: any) => {
                    switch (status) {
        ...
        render(): JSX.Element {
            ...
            return <page.Main {...config}
                ...
                <page.Filters collapsed={false} refreshIcon="fa fa-search">
                    ...
                    <Column size={[12, 12, 3, 3]} style={{paddingTop:'10px'}}>
                        <button id="btn-convert" style={{ display: 'none' }} className="btn-convrt-folio" onClick={this.generarFolio}> Generar folio seleccionado </button>
                    </Column>
