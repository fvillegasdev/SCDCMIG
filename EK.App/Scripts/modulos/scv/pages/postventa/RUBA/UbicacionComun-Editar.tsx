namespace EK.Modules.SCV.Pages.postventa.RUBA.UbicacionComun {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("UbicacionComun", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Ubicación Común";
