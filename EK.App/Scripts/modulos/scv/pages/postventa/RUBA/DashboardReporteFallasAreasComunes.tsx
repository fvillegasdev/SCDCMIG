namespace EK.Modules.SCV.Pages.postventa.RUBA.DashboardReporteFallasAreasComunes {
    "use strict";
    const DATOS_GRID_TABLERO: string = "DatosDashBoardReporteFallas";
    const config: page.IPageConfig = global.createPageConfig("ReporteFallasAreasComunes", "scv", [DATOS_GRID_TABLERO]);
    ...
    export const Vista: any = global.connect(class extends React.Component<IDashBoardReporteFallas, IDashBoardReporteFallasState>{
        ...
        onExport(): void {
            ...
            window.open("base/scv/ReporteFallasAreasComunes/exportar/" + encodedParams);
        };
        static dispatchs: any = (dispatch: Redux.Dispatch<any>) => ({
            obtenerGrid: (idPlaza: any, claveEstado: any, usuarioSeleccionado: any): void => {
                ...
                if (plaza.ID != undefined) {
                    ...
                    let params = global.assign({ IdPlaza: idPlaza, ClaveEstado: claveEstado, US: usuarioSeleccionado, CY: idAnio, MC: idMes, Fraccionamiento: idFraccionamiento })
                    global.dispatchAsyncPost("global-page-data", "base/scv/ReporteFallasAreasComunes/GetBP/getGridDashBoard/", { parametros: params }, DATOS_GRID_TABLERO);

                    //global.dispatchAsync("global-page-data", "base/scv/ReporteFallasAreasComunes/GetBP/getGridDashBoard/", { : params), DATOS_GRID_TABLERO);
                }
            },
            obtenerTop: (idPlaza: any, claveEstado: any, usuarioSeleccionado: any): void => {
                var fecha = new Date();
                ...
                let plaza = Forms.getValue("Plazas", PAGE_ID);
                if (plaza.ID != undefined) {
                    global.dispatchAsync("load::DatosDashBoardReporteTop", "base/scv/ReporteFallasAreasComunes/Get/getTopReportDashBoard/" + global.encodeObject({ IdPlaza: idPlaza, ClaveEstado: claveEstado, US: usuarioSeleccionado, CY: idAnio, MC: idMes }));
                }
            }
        });
        ...
        onNew(item: any, props: page.IProps): void {
            global.go("scv/pv/reporteFallasAreasComunes/id?nuevo");
        };
        onView(item: any, props: page.IProps): any {
            let id: number = item && item.ID ? item.ID : 0;
            if (id > 0) {
                go("scv/pv/reporteFallasAreasComunes/" + id, false);
            };
        };
        ...
        onClick(btn: any, input: any, props: select.ISelectProps): void {
            ...
            if (item && item.ID > 0) {
                go("scv/pv/reporteFallasAreasComunes/" + item.ID, false);
            };
        };
        render(): JSX.Element {
            ...
            dtConfig.columns
                .add({ data: "ID", width: "120px", order: "desc", fixed: true, format: formatConfigAcciones })
                .add({ data: "Cliente.Nombre", width: "350px" })
                .add({ data: "Desarrollo.Clave", width: "100px" })
                .add({ data: "Desarrollo.Nombre", width: "350px" })
                .addDateFormat({ title: "Fecha de creación", data: "Creado", width: "150px" })
                .add({ data: "CreadoPor.Nombre", width: "250px" })
                .add({ data: "EstatusReporte", width: "150px", format: formatEstatusReporte })
                .add({ title: "Teléfono de Casa", data: "Cliente.TelefonoCasa", width: "150px" })
                .add({ title: "Teléfono de Oficina", data: "Cliente.TelefonoOficina", width: "150px" })
                .add({ title: "Teléfono Otros", data: "Cliente.TelefonoOtros", width: "150px" })
            ...
            return <page.Main {...config} pageMode={PageMode.Principal} onView={this.onView.bind(this)} onFilter={this.onFilter.bind(this)} onNew={this.onNew.bind(this)} onExport={this.onExport.bind(this)}>
                ...
                <page.OptionSection
                    id={PAGE_ID}
                    subTitle={"Filtros del Reporte de Fallas Áreas Comunes"}
                    level={2}
                    ...
                    <Row style={{ marginBottom: 10 }}>
                        ...
                        <select.ReportesFallasAreasComuensSPV id="ReporteBuscador" label="Folio/Fraccionamiento" idForm={config.id} size={[12, 12, 6, 8]} iconButton="fas fa-arrow-right" buttonClick={this.onClick} />
                    </Row>
                    <Row>
    ...
    let DashBoardEstadosReporteFallas: any = global.connect(class extends React.Component<IEstadosReporteFallas, {}>{
        ...
        static dispatchs: any = (dispatch: Redux.Dispatch<any>) => ({
            getIndicadores: (ArgIdPlaza: any): void => {
                ...
                let plaza = Forms.getValue("Plazas", PAGE_ID);
                if (plaza.ID != undefined) {
                    dispatchAsync("load::dashBoardReporteFallasIndicadoresEstados", "base/scv/ReporteFallasAreasComunes/Get/getStateDashBoard/" + encodedParams);
                        ...
                        <div>
                            <ol className="dd-list " style={{ marginLeft: "-15px", marginRight: "-15px" }} >
                                ...
                                <li className={"dd-item dd3-item  dd3-content-ek  " + resaltar('ACT')} onClick={(e) => this.onClick("ACT", e)} data-id="210" style={{ cursor: "pointer" }}>
                                    ...
                                    <a className="btn">
                                        <i className={EstatusReporteFallasDashBoardInfo.iconos['ACT']} style={{ color: EstatusReporteFallasDashBoardInfo.iconosColor['ACT'] }}></i> <span style={{ fontSize: "11px" }}> Nuevos </span> </a>
                                </li>
                                {/*<li className={"dd-item dd3-item  dd3-content-ek  " + resaltar('W')} onClick={(e) => this.onClick("W", e)} data-id="212" style={{ cursor: "pointer" }} >
                                    ...
                                    <a className="btn">
                                        <i className={EstatusReporteFallasDashBoardInfo.iconos['W']} style={{ color: EstatusReporteFallasDashBoardInfo.iconosColor['W'] }}></i> <span style={{ fontSize: "11px" }}> Por Vencer </span>  </a>
                                </li>
                                    <li className={"dd-item dd3-item  dd3-content-ek    " + resaltar('V')} onClick={(e) => this.onClick("V", e)} data-id="213" style={{ cursor: "pointer" }}>
                                        ...
                                        <a className="btn">
                                            <i className={EstatusReporteFallasDashBoardInfo.iconos['V']} style={{ color: EstatusReporteFallasDashBoardInfo.iconosColor['V'] }}></i> <span style={{ fontSize: "11px" }}> Vencidos </span>  </a>
                                    </li>*/}
    ...
    export let BitacoraSPVButton: any = global.connect(class extends React.Component<IBitacoraSPVButtonProps, {}> {
        ...
        onButtonClick(): void {
            ...
            Forms.updateFormElement("BitacoraClienteAreasComunesSPV", "Usuario", null);
            ...
            dispatchSuccessful('load::TipoSeleccion', "F");
            //Forms.updateFormElement("BitacoraClienteAreasComunesSPV", "VerComentarios", { ID: 2, Clave: "C", Nombre: "Ver Comentarios Completo del Cliente" });
            setTimeout(() => {
