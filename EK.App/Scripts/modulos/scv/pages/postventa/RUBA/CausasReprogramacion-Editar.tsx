namespace EK.Modules.SCV.Pages.postventa.RUBA.CausasReprogramacion {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("CausasReprogramacion", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Causas de Reprogramación";
