namespace EK.Modules.SCV.Pages.postventa.RUBA.RezagosEntrega {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("RezagosEntrega", "scv");
    let ml: any = config.getML();
    let PAGE_ID = "Rezagos Entrega";
