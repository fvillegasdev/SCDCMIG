namespace EK.Modules.SCV.Pages.postventa.RUBA.ComentariosOrdenesTrabajoActivador {
    "use strict";
    ...
    let ModalComentarios: any = global.connect(class extends React.Component<IModalComentariosProps, {}> {
        ...
        onClose(): void {
            let modal: any = $("#modalComentariosOTActivador");
            modal.modal("hide");
        };
        ...
        render(): JSX.Element {
            ...
            return <modal.Modal id="modalComentariosOTActivador" header={this.header("Comentarios de Ordenes de trabajo")} addDefaultCloseFooter={false} footer={this.footerPersonalized()}>
                <Row>
                    <TablaComentarios />
                </Row>
            </modal.Modal>
    ...
    let TablaComentarios: any = global.connect(class extends React.Component<page.IProps, page.IProps> {
        ...
        static props: any = (state: any) => ({
            entidad: state.global.entity$actualizador$reporte$areas$comunes
        });
        ...
        render(): JSX.Element {
            ...
            let entidad = global.getData(this.props.entidad)
            let OTs;
            try {
                OTs = entidad.OrdenesTrabajo;
            } catch (ex) { }
...
import ModalComentariosOTActivador = EK.Modules.SCV.Pages.postventa.RUBA.ComentariosOrdenesTrabajoActivador.ComentariosModalBase;