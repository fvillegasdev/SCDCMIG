namespace EK.Modules.SCV.Pages.postventa.RUBA.AgendaDictamenAreasComunes {
    const PAGE_ID: string = "AgendaDictamenAreasComunes";
    ...
    export const AgendaDictamenAreasComunes: any = global.connect(class extends React.Component<IAgendaDictamenProps, IAgendaDictamenProps> {
...
import agendaDictamenAreasComunesPV = EK.Modules.SCV.Pages.postventa.RUBA.AgendaDictamenAreasComunes;