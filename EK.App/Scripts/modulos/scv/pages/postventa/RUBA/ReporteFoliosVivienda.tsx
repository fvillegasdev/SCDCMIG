namespace EK.Modules.SCV.Pages.Reportes.ReporteFoliosVivienda {
    "use strict";
    const PAGE_ID: string = "ReporteFoliosVivienda";
    const DXGRID_ID: string = "GridReporteFoliosVivienda";
