namespace EK.Modules.SCV.Pages.MotivosDescartarBoleta {
    ...
    let PAGE_ID = "Motivos de no-asignación (Boletas de Prospección)"
    export class Edicion extends page.Base {
        saveForm(props: page.IProps, item: EditForm): any {
            ...
            if (model.Catalogo !== null || model.Catalogo !== undefined) {
                let catalogo: any = {
                    ID: 0, Clave: "MOTIVOSRECHAZOBOLETAP", Nombre: ""
                };
            ...
            return <page.Edit>
                <Column size={[12, 12, 12, 12]} >
                    <page.OptionSection
                        id={PAGE_ID}
                        subTitle={PAGE_ID}
                        icon="fa fa-cubes" collapsed={false} hideCollapseButton={true}>
                        <Row>
