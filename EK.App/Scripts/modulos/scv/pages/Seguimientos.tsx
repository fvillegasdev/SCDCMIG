...
//        items?: any;
//    }
//    export class cSeguimientos extends React.Component<IProps, IProps>{
...
//            let columns: any[] = [
//                { title: $page.consulta.grid.headers.NumeroExpediente, data: "Expediente.ID" },
//                { title: $page.consulta.grid.headers.IdProspectacion, data: "Fase.IdProspectacion" },
//                { title: $page.consulta.grid.headers.IdVenta, data: "Fase.IdVenta" },
//                { title: $page.consulta.grid.headers.IdPostVenta, data: "Fase.IdPostVenta" },
//            ];
...
//        };
//    };
//    export const Consulta: any = ReactRedux.connect(cSeguimientos.props, cSeguimientos.dispatchs)(cSeguimientos);
