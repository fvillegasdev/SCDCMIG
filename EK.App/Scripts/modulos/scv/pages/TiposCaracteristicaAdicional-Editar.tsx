namespace EK.Modules.SCV.Pages.TiposCaracteristicaAdicional {
    "use strict";

    const config: page.IPageConfig = global.createPageConfig("tiposCaracteristica", "scv");
    let PAGE_ID = "Tipos de Características Adicionales";
