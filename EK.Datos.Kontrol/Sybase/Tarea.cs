...
//        : idata.ITarea
//    {
//        private const string USP_TAREABASE_SELECT = "{call usp_tareabase_select(?)}";
//        private const string USP_TAREA_INSERT = "{call usp_tarea_insert(?,?,?,?,?,?,?,?)}";
//        private const string USP_TAREA_UPDATE = "{call usp_tarea_update(?,?,?,?,?,?,?)}";
//        private const string USP_TAREA_DELETE = "{call usp_tarea_delete(?)}";
//        private const string USP_TAREA_REORDER = "{call usp_tarea_reorder(?)}";

//        private const string USP_DOCUMENTOSCOMUNES_SELECT = "{call usp_documentoscomunes_select(?,?,?)}";
//        private const string USP_DOCUMENTOSTAREA_INSERT = "{call usp_documentostarea_insert(?,?)}";
//        private const string USP_DOCUMENTOSTAREA_DELETE = "{call usp_documentostarea_delete(?)}";

//        private const string USP_ASIGNADOS_SELECT = "{call usp_tareaasignados_select(?,?)}";
//        private const string USP_ASIGNADOS_SEARCH = "{call usp_tareaasignados_search(?,?)}";
//        private const string USP_ASIGNADOS_INSERT = "{call usp_tareaasignados_insert(?,?,?)}";
//        private const string USP_ASIGNADOS_DELETE = "{call usp_tareaasignados_delete(?)}";
//        private const string USP_USUARIOSASIGNADOS_SELECT = "{call usp_tareaasignadosusuarios_select(?)}";

//        private idata.IDBHelper helper;

//        public Tarea(imodel.IContainerFactory factory, idata.IDBHelper helper)
//        {
//            //this.helper = helper;
...
//                        { "CreadoPor", task.IdCreadoPor },
//                        { "ModificadoPor", task.IdCreadoPor },
//                        { "Orden", task.Orden }
//                };
