...
namespace EK.Datos.Kontrol
{
        ...
        : dao.IDAOBase
    {
        ...
        public DAOBase(EK.Modelo.Kontrol.Interfaces.IContainerFactory factory, dao.IDBHelper helper, string defaultSelect, string defaultSave)
            : base()
        {
        ...
        public DAOBase(m.IContainerFactory factory, dao.IDBHelper helper, string defaultSelect, string defaultSave, string entityName)
